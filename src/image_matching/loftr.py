...
def match_images(image1, image2, model, device, amp, confidence_threshold=0.1):
    ...
    Parameters
    ----------
    image1: torch.Tensor of shape (1, 1, height, width)
        First image tensor

    image2: torch.Tensor of shape (1, 1, height, width)
        Second image tensor
    ...
    confidence_threshold: float
        Threshold to filter out keypoints with low confidence
